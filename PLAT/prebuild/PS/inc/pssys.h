...
#define     PS_ENABLE_EMC_BR_FEATURE               /*if IMS_EMC is enable,enable emergency attach/bearer feature */
#else
...
#define      PS_ENABLE_MDT_RLF_RPT_FEATURE          /* 718S basic(GCF), enable RlfReport feature */
#define      PS_ENABLE_MDT_CONN_EST_FAIL_RPT_FEATURE /* 718S basic(GCF), enable ConnEstFailReport feature*/
#define      PS_ENABLE_MDT_LOGGING_MEAS_FEATURE     /* 718S basic(GCF), enable LoggedMeasurement feature */
...
#define      PS_ENABLE_MDT_RLF_RPT_FEATURE          /* 718S mid, enable RlfReport feature */
#define      PS_ENABLE_MDT_CONN_EST_FAIL_RPT_FEATURE /* 718S mid, enable ConnEstFailReport feature*/
#define      PS_ENABLE_MDT_LOGGING_MEAS_FEATURE     /* 718S mid, enable LoggedMeasurement feature */
...
#elif defined FEATURE_IOTAT_ENABLE
#undef       PS_ENABLE_CP_OPT_FEATURE               /* 716S iotat, disable Control Plane opt feature */
#undef       PS_ENABLE_RATE_CTRL_FEATURE            /* 716S iotat, disable PLMN & APN Rate Control feature */
#undef       PS_ENABLE_TEST_LOOP_BACK_MODE_FEATURE  /* 716S iotat, disable TEST LOOP BACK MODE feature */
#undef       PS_ENABLE_SMS_FEATURE                  /* 716S iotat, disable SMS feature */
...
#undef       PS_ENABLE_MDT_RLF_RPT_FEATURE          /* 718S iotat, disable RlfReport feature */
#undef       PS_ENABLE_MDT_CONN_EST_FAIL_RPT_FEATURE /* 718S iotat, disable ConnEstFailReport feature*/
#undef       PS_ENABLE_MDT_LOGGING_MEAS_FEATURE     /* 718S iotat, disable LoggedMeasurement feature */
...
#undef       PS_ENABLE_EDRX_FEATURE                 /* 716S mid, disable edrx feature */
...
#define      PS_ENABLE_MDT_RLF_RPT_FEATURE          /* 718S mini, enable RlfReport feature */
#define      PS_ENABLE_MDT_CONN_EST_FAIL_RPT_FEATURE /* 718S mini, enable ConnEstFailReport feature*/
#define      PS_ENABLE_MDT_LOGGING_MEAS_FEATURE     /* 718S mini, enable LoggedMeasurement feature */
...
#define      PS_ENABLE_MDT_RLF_RPT_FEATURE          /* Except 718S, enable RlfReport feature */
#define      PS_ENABLE_MDT_CONN_EST_FAIL_RPT_FEATURE /* Except 718S, enable ConnEstFailReport feature*/
#define      PS_ENABLE_MDT_LOGGING_MEAS_FEATURE     /* Except 718S, enable LoggedMeasurement feature */
...
#undef       PS_ENABLE_SMS_FEATURE                  /* morerom, disable SMS feature */
#else
#define      PS_ENABLE_SMS_FEATURE                  /* Except 718S/morerom, enable SMS feature */
#endif

#endif

/**
 * For EC71X, one old SCT USB channel not used, change to used for PS EEA/EIA/SHA API
*/
#if 1
#if defined CHIP_EC618
#undef  ENABLE_SCT_EA_IA_SHA_API
#else
#define ENABLE_SCT_EA_IA_SHA_API
#endif
#else
#undef  ENABLE_SCT_EA_IA_SHA_API
#endif
