...
typedef enum _EPAT_CMI_DEV_PRIM_ID_TAG
{
    ...
    CMI_DEV_SET_LOG_DUMP_REQ,               //CmiDevSetLogDumpReq
    CMI_DEV_SET_LOG_DUMP_CNF,               //CmiDevSetLogDumpCnf
...
typedef enum CmiDevRrcEventTypeEnum_Tag
{
    ...
    CMI_DEV_RRC_DUMP_IND = 8,               /* report RRC dump info, only used for offline log function */
...
typedef enum CmiDevNasEventTypeEnum_Tag
{
    ...
    CMI_DEV_NAS_MT_DETACH,                  /* MT DETACH */
    CMI_DEV_NAS_FAKE_CELL_DETECT,           /* Detect fake cell */
    CMI_DEV_NAS_OUT_OF_SERVICE              /* UE is out of service, no cell is found to camp on */
...
/******************************************************************************
 * CMI_DEV_SET_LOG_DUMP_REQ
******************************************************************************/
typedef enum CmiDevLogDumpType_Enum
{
    CMI_DEV_LOG_DUMP_DISABLE  = 0,          //disable log dump URC feature
    CMI_DEV_LOG_DUMP_ENABLE_URC_RPT  = 1,   //enable dump log URC feature (report dump log continously)
    CMI_DEV_LOG_DUMP_ENABLE_IMMED_RPT = 2,  //trigger dump log into flash immediately (report dump log only once)
}CmiDevLogDumpType;

typedef struct CmiDevSetLogDumpReq_Tag
{
    //0: Disable Log Dump URC Indicator; 1: Enable Log Dump URC Indicator; 2: trigger Log Dump immediately
    UINT8           mode;
    UINT8           rsvd[3];
}CmiDevSetLogDumpReq;
 ...
 * CMI_DEV_SET_JDC_PARA_CNF
******************************************************************************/
typedef CamCmiEmptySig CmiDevSetLogDumpCnf;
