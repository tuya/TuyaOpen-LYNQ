...
/**
  \fn           OsaCfgNvmParseParam(const OsaCfgParam *pCfgParam, UINT8 cfgType, UINT16 expectLen, void *pOutValue)
...
*/
BOOL OsaCfgNvmParseParam(const OsaCfgParam *pCfgParam, UINT8 cfgType, UINT16 expectLen, void *pOutValue);
