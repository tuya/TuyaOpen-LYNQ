 ...
 * Add one "DlPduBlock"
*/
void OsaDlPduAddOne(DlPduBlock **ppHdr, DlPduBlock **ppTailer, DlPduBlock *pNew);

#define OsaDlPduSingleLinkAddOne(pHdr, pTailer, pNew)   \
    OsaDlPduAddOne(&(pHdr), &(pTailer), (pNew))

/*
 * Add "DlPduBlock" list at the end
*/
void OsaDlPduAddList(DlPduBlock **ppHdr, DlPduBlock **ppTailer, DlPduBlock *pNewHdr, DlPduBlock *pNewTailer);

#define OsaDlPduSingleLinkAddList(pHdr, pTailer, pNewHdr, pNewTailer)   \
    OsaDlPduAddList(&(pHdr), &(pTailer), (pNewHdr), (pNewTailer))

/*
 * Add one "UlPduBlock"
*/
void OsaUlPduAddOne(UlPduBlock **ppHdr, UlPduBlock **ppTailer, UlPduBlock *pNew);

#define OsaUlPduSingleLinkAddOne(pHdr, pTailer, pNew)   \
    OsaUlPduAddOne(&(pHdr), &(pTailer), (pNew))

/*
 * Add "UlPduBlock" list at the end
*/
void OsaUlPduAddList(UlPduBlock **ppHdr, UlPduBlock **ppTailer, UlPduBlock *pNewHdr, UlPduBlock *pNewTailer);

#define OsaUlPduSingleLinkAddList(pHdr, pTailer, pNewHdr, pNewTailer)   \
    OsaUlPduAddList(&(pHdr), &(pTailer), (pNewHdr), (pNewTailer))
