...
// 不同工程依赖不同互不影响，目前打包地址都默认定义在此文件
#define PKGFLX_GNSS_BLT_LNA             (0x00F60000)
#define PKGFLX_GNSS_BLT_SIZE            (    0x3E64)
#define PKGFLX_GNSS_APP_LNA             (0x00F64000)
#define PKGFLX_GNSS_APP_SIZE            (   0x328F4)
#endif
