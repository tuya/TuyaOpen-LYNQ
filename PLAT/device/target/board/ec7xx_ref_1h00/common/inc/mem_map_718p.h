...
#define AP_FLASH_LOAD_SIZE              (0x2DB000)//2876KB + 48KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x325000)//3172KB ,for ld + 48KB
#else
#define AP_FLASH_LOAD_ADDR              (0x0087e000)

#define AP_FLASH_LOAD_SIZE              (0x317000)//3116KB + 48KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x325000)//3172KB ,for ld + 48KB
#endif
...
#define FLASH_FS_REGION_END             (0x3ad000)  // 48KB + 48KB
