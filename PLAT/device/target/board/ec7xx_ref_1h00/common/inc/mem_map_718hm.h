...
#define ID2_SIZE                        0x2000
#define FLASHDB_SIZE                    0x10000
...
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x63F000 - ID2_SIZE - FLASHDB_SIZE - APPSDK_FLASH_SIZE)//6396KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x6D6000 - ID2_SIZE - FLASHDB_SIZE - APPSDK_FLASH_SIZE)//7000KB ,for ld
#else
#define AP_FLASH_LOAD_SIZE              (0x63F000 - ID2_SIZE - FLASHDB_SIZE)//6396KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x6D6000 - ID2_SIZE - FLASHDB_SIZE)//7000KB ,for ld
#endif
#else
#define AP_FLASH_LOAD_ADDR              (0x00891000)

#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x67B000 - ID2_SIZE - FLASHDB_SIZE - APPSDK_FLASH_SIZE)//6636KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x6D6000 - ID2_SIZE - FLASHDB_SIZE - APPSDK_FLASH_SIZE)//7000KB ,for ld
#else
#define AP_FLASH_LOAD_SIZE              (0x67B000 - ID2_SIZE - FLASHDB_SIZE)//6636KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x6D6000 - ID2_SIZE - FLASHDB_SIZE)//7000KB ,for ld
#endif
#endif
...
#define PSRAM_END_ADDR                  (0x0c800000 - APPSDK_RAM_SIZE)
#else
...
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define PSRAM_AREA_END_OFFSET           (0x00800000 - APPSDK_RAM_SIZE)
#else
