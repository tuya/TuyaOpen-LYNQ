...
#if (defined MID_FEATURE_MODE) || (defined GCF_FEATURE_MODE) || (defined FEATURE_IOTAT_ENABLE)
0x0001a000          |---------------------------------|
                    |      cp img 360KB               |
0x00074000          |---------------------------------|
                    |      ap img 1224KB              |
...
#if (defined FEATURE_REF_CR_ENABLE) || (defined FEATURE_IOTAT_ENABLE)
0x001be000          |---------------------------------|
#if defined (FEATURE_FOTA_FS_ENABLE)
                    |      lfs  160KB                 |
0x001e6000          |---------------------------------|
...
#if defined (FEATURE_FOTA_FS_ENABLE)
#define FLASH_FS_REGION_END             (0x1e6000)  // 160KB
#else
#define FLASH_FS_REGION_END             (0x1ca000)  // 48KB
#endif
...
#define FLASH_FS_REGION_SIZE            (FLASH_FS_REGION_END-FLASH_FS_REGION_START)
#if defined (FEATURE_FOTA_FS_ENABLE)
#define FLASH_FS_REGION_END             (0x1e6000)  //256KB
#else
#define FLASH_FS_REGION_END             (0x1b2000)  // 48KB
#endif
...
#if (defined FEATURE_IOTAT_ENABLE)
#define AP_FLASH_LOAD_SIZE              (0x14A000)//1320KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x159000)//1380KB ,for ld
//fs addr and size
#define FLASH_FS_REGION_START           (0x1be000)//size 160KB@iotat

#else //mini

#if (defined FEATURE_REF_CR_ENABLE)
#define AP_FLASH_LOAD_SIZE              (0x14C000)//1328KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x15B000)//1388KB ,for ld
//fs addr and size
#define FLASH_FS_REGION_START           (0x1be000)//size 160KB@refcr
#else
#define AP_FLASH_LOAD_SIZE              (0x134000)//1232KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x142000)//1288KB ,for ld
//fs addr and size
#define FLASH_FS_REGION_START           (0x1a6000)//size 256KB@non-refcr
#endif
...
#define FLASH_FS_REGION_SIZE            (FLASH_FS_REGION_END-FLASH_FS_REGION_START)
#if defined (FEATURE_FOTA_FS_ENABLE)
#define FLASH_FS_REGION_END             (0x1e6000)
...
//fota addr and size
#if defined (FEATURE_FOTA_FS_ENABLE)
#define FLASH_FOTA_REGION_START         (0x1e6000)
