...
#define APPSDK_FLASH_SIZE               0x8000
#endif
...
#define BOOTLOADER_FLASH_LOAD_SIZE              (0x16000)// 88kB, real region size, tool will check when zip TODO:ZIP
...
#if defined (FEATURE_GLO_CALI_ENABLE)
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x2C0000 - APPSDK_FLASH_SIZE)//2816KB
#else
#define AP_FLASH_LOAD_SIZE              (0x2C0000)//2816KB
#endif
#else //domestic
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x2D2000 - APPSDK_FLASH_SIZE)//2888KB
#else
...
#if defined (FEATURE_GLO_CALI_ENABLE)
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x2BC000 - APPSDK_FLASH_SIZE)//2800KB
#else
#define AP_FLASH_LOAD_SIZE              (0x2BC000)//2800KB
#endif
#else //domestic
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x2C7000 - APPSDK_FLASH_SIZE)//2844KB
#else
...
#if defined (FEATURE_GLO_CALI_ENABLE)
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x2F5000 - APPSDK_FLASH_SIZE)//3028KB
#else
#define AP_FLASH_LOAD_SIZE              (0x2F5000)//3028KB
#endif
#else //domestic
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_SIZE              (0x307000 - APPSDK_FLASH_SIZE)//3100KB
#else
...
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x320000 - APPSDK_FLASH_SIZE)//3200KB ,for ld
#else
...
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define APP_FLASH_EXIST                 (1)
#if (APP_FLASH_EXIST == 1)
#define APP_FLASH_LOAD_ADDR             (AP_FLASH_LOAD_ADDR + AP_FLASH_LOAD_SIZE)
#define APP_FLASH_LOAD_SIZE             APPSDK_FLASH_SIZE
#endif
#else
...
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define FLASH_MEM_BACKUP_ADDR           (AP_FLASH_LOAD_ADDR+AP_FLASH_LOAD_SIZE+APPSDK_FLASH_SIZE)
#else
...
#define FS_EXPANDED_SIZE                0xc000  // 48KB

//fs addr
#define FLASH_FS_REGION_START           (FLASH_MEM_BACKUP_NONXIP_ADDR + FLASH_MEM_BACKUP_SIZE - FS_EXPANDED_SIZE)
...
#else
//fs size
#define FLASH_FS_REGION_SIZE            (0x10000 + FS_EXPANDED_SIZE)  //112KB OEM
//fota size
#define FLASH_FOTA_REGION_LEN           (0x44000)  //272KB OEM
#endif
...
#else
//fs size
#define FLASH_FS_REGION_SIZE            (0xc000 + FS_EXPANDED_SIZE)  // 48KB
//fota size
...
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define APPSDK_RAM_SIZE                 0x8000
#define PSRAM_END_ADDR                  (0x0c400000 - APPSDK_RAM_SIZE)
#else
...
#ifdef FEATURE_SUBSYS_OPENSDK_ENABLE
#define PSRAM_AREA_END_OFFSET           (0x00400000 - APPSDK_RAM_SIZE)
#else
