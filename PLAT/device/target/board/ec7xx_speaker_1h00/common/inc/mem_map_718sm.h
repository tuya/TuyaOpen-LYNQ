...
#ifndef MEM_MAP_718SM_H
#define MEM_MAP_718SM_H

#include "pkg_718s_mapdef.h"


/*2M flash only, 4MB psram*/
...
#define PSRAM_AREA_P0_CP_OFFSET         (0x42000)
#define PSRAM_AREA_P1_OFFSET            (0x42000)
