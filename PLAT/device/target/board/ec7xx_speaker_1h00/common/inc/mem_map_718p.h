...
#define AP_FLASH_LOAD_SIZE              (0x2C7000)//2876KB - 32KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x311000)//3172KB ,for ld - 32KB
#else
#define AP_FLASH_LOAD_ADDR              (0x0087e000)

#define AP_FLASH_LOAD_SIZE              (0x303000)//3116KB - 32KB
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x311000)//3172KB ,for ld - 32KB
#endif
