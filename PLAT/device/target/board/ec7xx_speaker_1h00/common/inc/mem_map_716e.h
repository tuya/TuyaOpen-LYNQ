...
#define AP_FLASH_LOAD_SIZE              (0x277000)//3116 - 32 - 560 = 2524KB
...
#else
#define FLASH_FS_REGION_END             (0x3DF000)  // 248KB

//fota addr and size
#define FLASH_FOTA_REGION_START         (0x3DF000)
#define FLASH_FOTA_REGION_LEN           (0x44000)//72KB
#endif
...
#endif
#ifdef FEATURE_MORERAM_ENABLE
#define up_buf_start 0x49e000   // should be 4 byte align
