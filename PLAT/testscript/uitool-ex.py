...
def get_file(arg):
    #open port
    ser = serial.Serial(DEFAULT_PORT, DEFAULT_BAUD, bytesize=8, parity='N', stopbits=1, timeout=3)
    ser.close()
    ser.open()
    print("* Target Connected.       *")
    str_name = os.path.basename(arg)
    GET_CMD = b'get d:/'+str_name.encode('utf-8')+b'\r\n'
    promt_lens = 10
