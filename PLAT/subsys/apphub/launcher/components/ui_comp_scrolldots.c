...
lv_obj_t *ui_Scrolldots_create(lv_obj_t *comp_parent)
{
    ...
    // if(children) lv_mem_free(children);
    children = lv_mem_alloc(sizeof(lv_obj_t *) * _UI_COMP_SCROLLDOTS_NUM);
