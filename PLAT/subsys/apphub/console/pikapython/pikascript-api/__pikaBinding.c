...
PikaObj *New_PikaMain(Args *args){
    ...
    obj_newObj(self, "ec7xx", "ec7xx", New_ec7xx);
...
#ifndef PIKA_MODULE_PIKASTDDEVICE_DISABLE
void PikaStdDevice_Timer___init__Method(PikaObj *self, Args *args){
...
void PikaStdDevice_Timer_closeMethod(PikaObj *self, Args *args){
...
void PikaStdDevice_Timer_disableMethod(PikaObj *self, Args *args){
...
void PikaStdDevice_Timer_enableMethod(PikaObj *self, Args *args){
...
void PikaStdDevice_Timer_getIdMethod(PikaObj *self, Args *args){
...
void PikaStdDevice_Timer_getNameMethod(PikaObj *self, Args *args){
...
void PikaStdDevice_Timer_setCallbackMethod(PikaObj *self, Args *args){
...
void PikaStdDevice_Timer_setIdMethod(PikaObj *self, Args *args){
    int id = args_getInt(args, "id");
...
void PikaStdDevice_Timer_setModeMethod(PikaObj *self, Args *args){
    char* mode = args_getStr(args, "mode");
...
void PikaStdDevice_Timer_setNameMethod(PikaObj *self, Args *args){
    char* name = args_getStr(args, "name");
...
void PikaStdDevice_Timer_setPeriodMethod(PikaObj *self, Args *args){
...
#ifndef PIKA_MODULE_EC7XX_DISABLE
void ec7xx_ADCMethod(PikaObj *self, Args *args){
    Arg* res = ec7xx_ADC(self);
    method_returnArg(args, res);
}
method_typedef(
    ec7xx_ADC,
...
void ec7xx_GPIOMethod(PikaObj *self, Args *args){
    Arg* res = ec7xx_GPIO(self);
    method_returnArg(args, res);
}
method_typedef(
    ec7xx_GPIO,
...
void ec7xx_IICMethod(PikaObj *self, Args *args){
    Arg* res = ec7xx_IIC(self);
    method_returnArg(args, res);
}
method_typedef(
    ec7xx_IIC,
...
void ec7xx_PWMMethod(PikaObj *self, Args *args){
    Arg* res = ec7xx_PWM(self);
    method_returnArg(args, res);
}
method_typedef(
    ec7xx_PWM,
...
void ec7xx_SPIMethod(PikaObj *self, Args *args){
    Arg* res = ec7xx_SPI(self);
    method_returnArg(args, res);
}
method_typedef(
    ec7xx_SPI,
...
void ec7xx_TaskMethod(PikaObj *self, Args *args){
    Arg* res = ec7xx_Task(self);
    method_returnArg(args, res);
}
method_typedef(
    ec7xx_Task,
...
void ec7xx_UARTMethod(PikaObj *self, Args *args){
    Arg* res = ec7xx_UART(self);
    method_returnArg(args, res);
}
method_typedef(
    ec7xx_UART,
...
class_def(ec7xx){
    __BEFORE_MOETHOD_DEF
    constructor_def(ec7xx_ADC, 193450093),
    constructor_def(ec7xx_IIC, 193458970),
    constructor_def(ec7xx_PWM, 193467065),
    constructor_def(ec7xx_SPI, 193470097),
    constructor_def(ec7xx_GPIO, 2089114740),
    constructor_def(ec7xx_UART, 2089601825),
    constructor_def(ec7xx_Task, 2089601848),
};
class_inhert(ec7xx, TinyObj);

PikaObj *New_ec7xx(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, ec7xx);
    return self;
}
#endif
...
class_inhert(ec7xx_ADC, PikaStdDevice_ADC);

PikaObj *New_ec7xx_ADC(Args *args){
    PikaObj *self = New_PikaStdDevice_ADC(args);
    obj_setClass(self, ec7xx_ADC);
    return self;
}

Arg *ec7xx_ADC(PikaObj *self){
    return obj_newObjInPackage(New_ec7xx_ADC);
}
#endif

#ifndef PIKA_MODULE_EC7XX_DISABLE
class_def(ec7xx_GPIO){
    __BEFORE_MOETHOD_DEF
};
class_inhert(ec7xx_GPIO, PikaStdDevice_GPIO);

PikaObj *New_ec7xx_GPIO(Args *args){
    PikaObj *self = New_PikaStdDevice_GPIO(args);
    obj_setClass(self, ec7xx_GPIO);
    return self;
}

Arg *ec7xx_GPIO(PikaObj *self){
    return obj_newObjInPackage(New_ec7xx_GPIO);
}
#endif
...
class_inhert(ec7xx_IIC, PikaStdDevice_IIC);

PikaObj *New_ec7xx_IIC(Args *args){
    PikaObj *self = New_PikaStdDevice_IIC(args);
    obj_setClass(self, ec7xx_IIC);
    return self;
}

Arg *ec7xx_IIC(PikaObj *self){
    return obj_newObjInPackage(New_ec7xx_IIC);
}
#endif
...
class_inhert(ec7xx_PWM, PikaStdDevice_PWM);

PikaObj *New_ec7xx_PWM(Args *args){
    PikaObj *self = New_PikaStdDevice_PWM(args);
    obj_setClass(self, ec7xx_PWM);
    return self;
}

Arg *ec7xx_PWM(PikaObj *self){
    return obj_newObjInPackage(New_ec7xx_PWM);
}
#endif
...
class_inhert(ec7xx_SPI, PikaStdDevice_SPI);

PikaObj *New_ec7xx_SPI(Args *args){
    PikaObj *self = New_PikaStdDevice_SPI(args);
    obj_setClass(self, ec7xx_SPI);
    return self;
}

Arg *ec7xx_SPI(PikaObj *self){
    return obj_newObjInPackage(New_ec7xx_SPI);
}
#endif

#ifndef PIKA_MODULE_EC7XX_DISABLE
class_def(ec7xx_Task){
    __BEFORE_MOETHOD_DEF
};
class_inhert(ec7xx_Task, PikaStdTask_Task);

PikaObj *New_ec7xx_Task(Args *args){
    PikaObj *self = New_PikaStdTask_Task(args);
    obj_setClass(self, ec7xx_Task);
    return self;
}

Arg *ec7xx_Task(PikaObj *self){
    return obj_newObjInPackage(New_ec7xx_Task);
}
#endif

#ifndef PIKA_MODULE_EC7XX_DISABLE
class_def(ec7xx_UART){
    __BEFORE_MOETHOD_DEF
};
class_inhert(ec7xx_UART, PikaStdDevice_UART);

PikaObj *New_ec7xx_UART(Args *args){
    PikaObj *self = New_PikaStdDevice_UART(args);
    obj_setClass(self, ec7xx_UART);
    return self;
}

Arg *ec7xx_UART(PikaObj *self){
    return obj_newObjInPackage(New_ec7xx_UART);
}
#endif
