...
#define LOG_TRACE(format, level, func, line, ...) hal_printf("%s-%s(%d): "format, level, func, line,##__VA_ARGS__)
...
#define LOGV(format, ...) LOG_TRACE(format, "V", __func__, __LINE__, ##__VA_ARGS__)
#define LOGD(format, ...) LOG_TRACE(format, "D", __func__, __LINE__, ##__VA_ARGS__)
#define LOGI(format, ...) LOG_TRACE(format, "I", __func__, __LINE__, ##__VA_ARGS__)
#define LOGW(format, ...) LOG_TRACE(format, "W", __func__, __LINE__, ##__VA_ARGS__)
#define LOGE(format, ...) LOG_TRACE(format, "E", __func__, __LINE__, ##__VA_ARGS__)
#define LOGF(format, ...) LOG_TRACE(format, "F", __func__, __LINE__, ##__VA_ARGS__)
