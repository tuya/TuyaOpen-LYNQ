 ...
 * @return 操作结果的状态码。
 */
__byte_rtc_api__ uint32_t volc_encrypt_or_decrypt(bool encrypt, const char* key, uint64_t iv, const unsigned char* input, uint32_t ilen, unsigned char* output, uint32_t* olen);
