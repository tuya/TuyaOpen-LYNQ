#ifndef __G726CODEC_H__
#define __G726CODEC_H__
 ...
 *
 * check return:
 *    g_state726_xx struct returned on success, 
 *    and if failed, NULL is returned.
 */
g726_state_t *G726_Init( g726_state_t *gs, int bit );

/* (zqj)  
 * function: convert PCM to g726 (16/24/32/40 kbps) audio format.
 *	 bit_rate:		index g726 16/24/32/40 kbps.
