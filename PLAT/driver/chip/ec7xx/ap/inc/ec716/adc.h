 ...
 * File name:    adc.h
 * Description:  EC7XX adc driver header file
 * History:
 ****************************************************************************/
...
typedef enum
{
    ADC_VBAT_RESDIV_RATIO_8OVER32     = 0U,  /**< ADC VBAT RESDIV select as 8/32 VBAT */
    ADC_VBAT_RESDIV_RATIO_7OVER32     = 1U,  /**< ADC VBAT RESDIV select as 7/32 VBAT */
    ADC_VBAT_RESDIV_RATIO_6OVER32     = 2U,  /**< ADC VBAT RESDIV select as 6/32 VBAT */
    ADC_VBAT_RESDIV_RATIO_5OVER32     = 3U,  /**< ADC VBAT RESDIV select as 5/32 VBAT */
    ADC_VBAT_RESDIV_RATIO_4OVER32     = 4U,  /**< ADC VBAT RESDIV select as 4/32 VBAT */
    ADC_VBAT_RESDIV_RATIO_3OVER32     = 5U,  /**< ADC VBAT RESDIV select as 3/32 VBAT */
    ADC_VBAT_RESDIV_RATIO_2OVER32     = 6U,  /**< ADC VBAT RESDIV select as 2/32 VBAT */
    ADC_VBAT_RESDIV_RATIO_1OVER32     = 7U,  /**< ADC VBAT RESDIV select as 1/32 VBAT */
} AdcVbatResdiv_e;
