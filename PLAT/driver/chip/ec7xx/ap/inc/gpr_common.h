...
#define APRSTREQ_USBC_HRST_BIT (1UL<< 9)
#define APRSTREQ_USBC_PHYRST_BIT (1UL<< 27)
#define APRSTREQ_USBP_PORRST_BIT (1UL<< 28)
#define APRSTREQ_USBP_UTMIRST_BIT (1UL<< 29)


#define APRSTREQ_HOLDER_FOR_USB_MASK  (APRSTREQ_USBC_HRST_BIT|APRSTREQ_USBC_PHYRST_BIT|APRSTREQ_USBP_PORRST_BIT|APRSTREQ_USBP_UTMIRST_BIT)
...
#define RESET_RELEASE_DELAY_US                       (306)
...
#ifdef TYPE_EC718M
#define CAN0_RESET_VECTOR                MAKE_RESET_VECTOR(RESET_RELEASE_DELAY_US, {RST_PCLK_CAN0, RST_FCLK_CAN0, RST_PCLK_CAN0, RST_FCLK_CAN0})
#define CAN_RESET_VECTORS                {CAN0_RESET_VECTOR}
#endif
