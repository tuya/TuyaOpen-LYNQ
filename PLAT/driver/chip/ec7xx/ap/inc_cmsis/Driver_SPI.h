...
#define ARM_SPI_PURGE_COMM              (0x15UL << ARM_SPI_CONTROL_Pos)     ///< Purge communication(clear rx fifo)
...
#define ARM_SPI_EVENT_RX_TIMEOUT        (1UL << 3)  ///< Receive timeout
...
typedef struct _ARM_DRIVER_SPI {
  ...
  int32_t              (*StopSend)        (void);                             ///< Used to SPI Codec.
