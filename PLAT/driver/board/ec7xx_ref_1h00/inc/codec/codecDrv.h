...
#define HAL_CODEC_VOL_SPEAKER_DEFAULT  60
#define HAL_CODEC_MIC_GAIN_DEFAULT     4
#else
...
#if MBTK_PRODUCT_TARGET_L511C_Y7PVM
#define CODEC_PA_GPIO_INSTANCE        (1)
#define CODEC_PA_GPIO_PIN             (4)
#define CODEC_PA_PAD_INDEX            (45)
#define CODEC_PA_PAD_ALT_FUNC         (PAD_MUX_ALT0)
#else
#define CODEC_PA_GPIO_INSTANCE        (1)
#define CODEC_PA_GPIO_PIN             (1)
#define CODEC_PA_PAD_INDEX            (12)
#define CODEC_PA_PAD_ALT_FUNC         (PAD_MUX_ALT4)
#endif
