...
/*
 * \brief       Active dump key info to Flash when receiving
                indication from PS+PHY or Customer's MCU and then
                to send signal to Customer's MCU
 * \param[in]   void.
 * \returns     void
 */
void excepActiveDumpExcepKeyInfoToFlash(void);
#endif
#endif
