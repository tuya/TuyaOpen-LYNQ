...
typedef enum
{
    /*Warning:Part1~Part3 of Customer has occupied by PS*/
...
#define EC_EXCEP_INFO_PART_NUM_CUST       EC_EXCEP_INFO_PART_15 /*Warning:Part1~Part3 of Customer has occupied by PS*/
...
typedef enum _EPAT_Flash_Dump_Enums
{
    ...
    /* PS RRC, use CUST PART1 - PART3, total size 1K */
    EPAT_CUST_PS_PART1_CerrcUeCapability        = 0x21,
    EPAT_CUST_PS_PART2_CerrcDedicatedPriority   = 0x22,
    EPAT_CUST_PS_PART3_CerrcCellDumpInfo        = 0x23,
}FlashDumpEnums_e;
...
/**
  \fn        excepDumpExcepKeyInfoToFlashSafe(void)
  \brief     used to dump key info to flash (thread safe)
  \param[in]
  \note
 */
int excepDumpExcepKeyInfoToFlashSafe(void);
