...
typedef enum
{
    ...
    PS_URC_ID_DEV_JAMM_DETECT_EVENT,
    ...
    PS_URC_ID_USAT_GEO_LOC_REQ, /**< USAT proactive cmd: Geographical Location request */
    PS_URC_ID_USAT_PROACT_CMD,  /**< USAT proactive cmd raw data report: play tone/display text/get inkey/
                                ** get input/select item/setup menu/setup idle mode text/langue notification,
                                ** additional command type 0xFD means proactive command session end
                                */
    ...
    PS_URC_ID_IMS_CALL_DISCONNECT, /* URC: NO CARRIER */
    PS_URC_ID_IMS_CALLING_NUMBER_PRESENT, /* URC: +CLIP, Originating Id presentation*/
    PS_URC_ID_IMS_CONNECTED_NUMBER_PRESENT, /* URC: +COLP, Terminating Id presentation*/
    PS_URC_ID_IMS_CALL_WAITING, /* URC: +CCWA */
...
typedef enum
{
    ...
    PS_GROUP_IMS_MASK  = (0x01 << 7),           //0x00000080
...
#ifdef FEATURE_IMS_ENABLE
/**
  \fn    void psImiIndToAppEventTrigger(const SignalBuf *indSignalPtr)
  \brief Function to transfer indication to event trigger.
 */
void psImiIndToAppEventTrigger(const SignalBuf *indSignalPtr);
#endif
