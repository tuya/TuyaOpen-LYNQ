 ...
 *----------------------------------------------------------------------------*/
typedef enum _EPAT_CcioChanMsgIdTag
{
    /* control msg */
...
int32_t ccioBuildMsgRmtWkToTx(CcioChanMessage_t *chmsg, CcioChanMessageId_e msgId, CcioDsaRmtWkToTx_t *dsaRmtWkTx);
