...
#define ATC_SMS_SEND_MSG_GUARD_TIMER    60  /* second */
...
/* AT+CPNER */
#define ATC_CPNER_0_REPORT_VAL_MIN              0
#define ATC_CPNER_0_REPORT_VAL_MAX              1
#define ATC_CPNER_0_REPORT_VAL_DEFAULT          0
...
CmsRetId  smsCPNER(const AtCmdInputContext *pAtCmdReq);
