...
/*AT+ECIPSECCREATE Parameters Macro define*/
#define ECIPSECCREATE_0_VAL_DEF          NULL
#define ECIPSECCREATE_0_VAL_MAXLEN       AT_SOC_IP_ADDR_STRING_LENGTH_MAX

#define ECIPSECCREATE_1_VAL_DEF          NULL
#define ECIPSECCREATE_1_VAL_MAXLEN       AT_SOC_IP_ADDR_STRING_LENGTH_MAX

#define ECIPSECCREATE_2_VAL_MIN          AT_SOC_PORT_MIN
#define ECIPSECCREATE_2_VAL_MAX          AT_SOC_PORT_MAX
#define ECIPSECCREATE_2_VAL_DEF          (0)

#define ECIPSECCREATE_3_VAL_MIN          AT_SOC_PORT_MIN
#define ECIPSECCREATE_3_VAL_MAX          AT_SOC_PORT_MAX
#define ECIPSECCREATE_3_VAL_DEF          (0)

#define ECIPSECCREATE_4_VAL_MIN          (1)
#define ECIPSECCREATE_4_VAL_MAX          (0x7FFFFFFF)
#define ECIPSECCREATE_4_VAL_DEF          (0)

#define ECIPSECCREATE_5_VAL_MIN          (1)
#define ECIPSECCREATE_5_VAL_MAX          (0x7FFFFFFF)
#define ECIPSECCREATE_5_VAL_DEF          (0)

#define ECIPSECCREATE_6_VAL_MIN          (0)
#define ECIPSECCREATE_6_VAL_MAX          (2)
#define ECIPSECCREATE_6_VAL_DEF          (0)

#define ECIPSECCREATE_7_VAL_MIN          (0)
#define ECIPSECCREATE_7_VAL_MAX          (2)
#define ECIPSECCREATE_7_VAL_DEF          (0)

#define ECIPSECCREATE_8_VAL_MIN          (0)
#define ECIPSECCREATE_8_VAL_MAX          (3)
#define ECIPSECCREATE_8_VAL_DEF          (0)

#define ECIPSECCREATE_9_VAL_DEF          NULL
#define ECIPSECCREATE_9_VAL_MAXLEN       (32)

#define ECIPSECCREATE_10_VAL_MIN          (0)
#define ECIPSECCREATE_10_VAL_MAX          (4)
#define ECIPSECCREATE_10_VAL_DEF          (0)

#define ECIPSECCREATE_11_VAL_DEF          NULL
#define ECIPSECCREATE_11_VAL_MAXLEN       (32)

#define ECIPSECCREATE_12_VAL_MIN          (1)
#define ECIPSECCREATE_12_VAL_MAX          (0x7FFFFFFF)
#define ECIPSECCREATE_12_VAL_DEF          (0x7FFFFFFF)

/*AT+ECIPSECCREATE Parameters Macro define end*/

/*AT+ECIPSECDELETE Parameters Macro define*/
#define ECIPSECDELETE_0_VAL_MIN           (1)
#define ECIPSECDELETE_0_VAL_MAX           (128)
#define ECIPSECDELETE_0_VAL_DEF           (0)
...
CmsRetId  nmECIPSECCREATE(const AtCmdInputContext *pAtCmdReq);
CmsRetId  nmECIPSECDELETE(const AtCmdInputContext *pAtCmdReq);
