...
#ifdef FEATURE_PLAT_REF_CR_MISC_MREBOOT_ENABLE
#define ATC_MREBOOT_VAL_MIN                     0
#define ATC_MREBOOT_VAL_MAX                     1
#define ATC_MREBOOT_VAL_DEFAULT                 0
#endif
...
#define ATC_ECPCFG_LOG_OWNER_VAL_MAX                9  /* caution: only 32 bits for ownerId */
...
#define ATC_ECPCFG_USB_SW_TRACEFLAG_VAL_MAX             0x03f
#define ATC_ECPCFG_USB_SW_TRACEFLAG_VAL_DEFAULT          0


#define ATC_ECPCFG_USB_SUP_SPD_RECFG_VAL_MIN             0
#define ATC_ECPCFG_USB_SUP_SPD_RECFG_VAL_MAX             1
#define ATC_ECPCFG_USB_SUP_SPD_RECFG_VAL_DEFAULT          0
...
#define ATC_ECPCFG_WFI_MODE_MAX                 3
#define ATC_ECPCFG_WFI_MODE_DEFAULT             0

#define ATC_ECPCFG_CPSlPTEST_MODE_MIN               0
#define ATC_ECPCFG_CPSlPTEST_MODE_MAX               6
#define ATC_ECPCFG_CPSlPTEST_MODE_DEFAULT           0
#endif
...
#ifdef FEATURE_PLAT_REF_CR_PER_MLED_ENABLE
/* AT+MLED */
#define ATC_MLED_MODE_VAL_MIN                0
#define ATC_MLED_MODE_VAL_MAX                1
#define ATC_MLED_MODE_VAL_DEFAULT            0
#endif

#ifdef FEATURE_PLAT_PER_ECLEDMODE_ENABLE
/* AT+ECLEDMODE */
...
#ifdef FEATURE_PLAT_REF_CR_MISC_MPOF_ENABLE
/* AT+MPOF */
#define ATC_MPOF_VAL_MIN                          0
#define ATC_MPOF_VAL_MAX                          1
#define ATC_MPOF_VAL_DEFAULT                      0
#endif

#ifdef FEATURE_PLAT_MISC_ECPOWD_ENABLE
/* AT+ECPOWD */
...
#define ATC_CMUX_MODE_VAL_MIN               0
#define ATC_CMUX_MODE_VAL_MAX               1
#define ATC_CMUX_MODE_VAL_DFT               0

//mode: 0-UIH only, 1-UI only, 2-I only
#define ATC_CMUX_SUBSET_VAL_MIN             0
#define ATC_CMUX_SUBSET_VAL_MAX             2
#define ATC_CMUX_SUBSET_VAL_DFT             0

//port speed: 1-9600, 2-19200, 3-38400, 4-57600, 5-115200, 6-230400, 7-460800, 8-921600
#define ATC_CMUX_SPEED_VAL_MIN              1
#define ATC_CMUX_SPEED_VAL_MAX              8
#define ATC_CMUX_SPEED_VAL_DFT              5

//<N1>: integer type (maximum frame size)
#define ATC_CMUX_N1_VAL_MIN                 1
#define ATC_CMUX_N1_VAL_MAX                 32768
#define ATC_CMUX_N1_VAL_DFT                 31

//<T1>:integer type (acknowledgement timer in units of ten milliseconds)
#define ATC_CMUX_T1_VAL_MIN                 1
#define ATC_CMUX_T1_VAL_MAX                 255
#define ATC_CMUX_T1_VAL_DFT                 10

//<N2>: integer type (maximum number of re-transmissions).
#define ATC_CMUX_N2_VAL_MIN                 0
#define ATC_CMUX_N2_VAL_MAX                 100
#define ATC_CMUX_N2_VAL_DFT                 3

//<T2>:integer type (response timer for the multiplexer control channel in units of ten milliseconds).
#define ATC_CMUX_T2_VAL_MIN                 2
#define ATC_CMUX_T2_VAL_MAX                 255
#define ATC_CMUX_T2_VAL_DFT                 30

//<T3>:integer type (wake up response timer in seconds).
#define ATC_CMUX_T3_VAL_MIN                 1
#define ATC_CMUX_T3_VAL_MAX                 255
#define ATC_CMUX_T3_VAL_DFT                 10

//<K>: integer type (window size, for Advanced option with Error-Recovery Mode).
#define ATC_CMUX_K_VAL_MIN                  1
#define ATC_CMUX_K_VAL_MAX                  7
#define ATC_CMUX_K_VAL_DFT                  2

#ifdef FEATURE_AT_PWR_TEST
/* AT+ECPERTEST */
...
#define ATC_ECPERTEST_SLEEPMODE_VAL_MAX             12
...
#define ATC_ECPERTEST_LOOPCASENUM_VAL_MIN        0
#define ATC_ECPERTEST_LOOPCASENUM_VAL_MAX        4
#define ATC_ECPERTEST_LOOPCASENUM_VAL_DEFAULT    0
#endif

#ifdef FEATURE_PLAT_REF_CR_MISC_MLPMCFG_ENABLE
#define ATC_MLPMCFG_CMD_STR_MAX_LEN                 12
#define ATC_MLPMCFG_CMD_STR_DEFAULT                 NULL
#define ATC_MLPMCFG_SLEEPIND_VALUE_MIN              0
#define ATC_MLPMCFG_SLEEPIND_VALUE_MAX              3
#define ATC_MLPMCFG_SLEEPIND_VALUE_DEFAULT          0
#define ATC_MLPMCFG_SLEEPMODE_VALUE_MIN             0
#define ATC_MLPMCFG_SLEEPMODE_VALUE_MAX             2
#define ATC_MLPMCFG_SLEEPMODE_VALUE_DEFAULT         2
#define ATC_MLPMCFG_PERMANENT_VALUE_MIN             0
#define ATC_MLPMCFG_PERMANENT_VALUE_MAX             1
#define ATC_MLPMCFG_PERMANENT_VALUE_DEFAULT         0
#define ATC_MLPMCFG_DELAYSLEEP_VALUE_MIN            0
#define ATC_MLPMCFG_DELAYSLEEP_VALUE_MAX            300
#define ATC_MLPMCFG_DELAYSLEEP_VALUE_DEFAULT        0
#endif

#ifdef FEATURE_PLAT_REF_CR_PER_GPIO_ENABLE
// AT+MGPIO
#define ATC_MGPIO_PIN_VAL_MIN                       0
#define ATC_MGPIO_PIN_VAL_MAX                       3
#define ATC_MGPIO_PIN_VAL_DEFAULT                   0

#define ATC_MGPIO_CTRL_VAL_MIN                      0
#define ATC_MGPIO_CTRL_VAL_MAX                      2
#define ATC_MGPIO_CTRL_VAL_DEFAULT                  0

#define ATC_MGPIO_PULL_VAL_MIN                      0
#define ATC_MGPIO_PULL_VAL_MAX                      2
#define ATC_MGPIO_PULL_VAL_DEFAULT                  0

#define MGPIO_DIR_INPUT                             0
#define MGPIO_DIR_OUTPUT                            1
#define MGPIO_DIR_HIGHZ                             2

#define MGPIO_PULL_FLOATING                         0
#define MGPIO_PULL_DOWN                             1
#define MGPIO_PULL_UP                               2
#endif

//CmsRetId pdevHELP(const AtCmdInputContext *pAtCmdReq);
#ifdef FEATURE_PLAT_REF_CR_MISC_MREBOOT_ENABLE
CmsRetId pdevMREBOOT(const AtCmdInputContext *pAtCmdReq);
#endif
#ifdef FEATURE_PLAT_REF_CR_MISC_MLPMCFG_ENABLE
CmsRetId pdevMLPMCFG(const AtCmdInputContext *pAtCmdReq);
#endif
#ifdef FEATURE_REF_AT_CR_ENABLE
CmsRetId pdevMGPIO(const AtCmdInputContext *pAtCmdReq);
#endif
#ifdef FEATURE_PLAT_MISC_ECRST_ENABLE
...
#ifdef FEATURE_PLAT_REF_CR_PER_MLED_ENABLE
CmsRetId pdevMLED(const AtCmdInputContext *pAtCmdReq);
#endif
#ifdef FEATURE_PLAT_PER_ECLEDMODE_ENABLE
...
#ifdef FEATURE_PLAT_REF_CR_MISC_MPOF_ENABLE
CmsRetId pdevMPOF(const AtCmdInputContext *pAtCmdReq);
#endif
#ifdef FEATURE_PLAT_MISC_ECPOWD_ENABLE
