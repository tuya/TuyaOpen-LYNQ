...
typedef struct AtRefCrSocketCloseReq_Tag{
    UINT8 connetId;
    UINT8 mode;     //Only support 0:For TCP, close socket after data in buff sending complete
    UINT16 rsvd;
    UINT32 reqSource;
}AtRefCrSocketCloseReq;//8 bytes


typedef UINT32 AtRefCrCfgQryReq;

typedef struct AtRefCrCfgQryRsp_Tag
{
    UINT16  result;
    UINT8   rsv[2];
