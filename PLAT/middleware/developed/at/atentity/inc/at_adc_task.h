...
#define AT_ADC_REQ_BITMAP_AIO1    (0x4)
#define AT_ADC_REQ_BITMAP_AIO2    (0x8)
#endif

#ifdef FEATURE_MIFI_CONFIG_ENABLE
#define AT_MIFI_REQ_BITMAP_VBAT	  (0x4)
#endif
...
int32_t adcSendMsg(uint32_t atHandle, osMessageQueueId_t msgHandle, uint32_t req);
