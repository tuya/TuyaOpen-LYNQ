...
#define MUXAT_CHAN_NAME           "MUXAT"
#define MSXAT_CHAN_NAME_LEN       5
...
/*
 * Seems no one use it now
*/
#undef  AT_UART_PRINT_API_ENABLE
#ifdef  AT_UART_PRINT_API_ENABLE
/*
...
#ifdef  FEATURE_RIL_AT_API_ENABLE
/*
 * AT RIL API
*/
