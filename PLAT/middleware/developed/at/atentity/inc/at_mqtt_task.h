...
#define MQTT_SEMPHR_NOT_CREATE   0 
...
#define MQTT_CONTEXT_NUMB_MAX      6
...
#define KEEPALIVE_RETRY_MAX    6
#define MQTT_RECONN_MAX       6

#define ALI_DYNAMIC_REGISTER_IS_NOT_USED       0
#define ALI_DYNAMIC_REGISTER_IS_USED           1

#define MQTT_SLP_NAME_LEN        12

enum MQTT_CLIENT_CHANNEL_TYPE
{
    MQTT_CLIENT_CHANNEL_0 = 0,
    MQTT_CLIENT_CHANNEL_1 = 1,
    MQTT_CLIENT_CHANNEL_2 = 2,
    MQTT_CLIENT_CHANNEL_3 = 3,
    MQTT_CLIENT_CHANNEL_4 = 4,
    MQTT_CLIENT_CHANNEL_5 = 5,
    MQTT_CLIENT_CHANNEL_MAX
};
...
typedef struct
{
    int       channel;
    uint8_t   slpHandler;
    uint8_t   slpName[MQTT_SLP_NAME_LEN];
    uint8_t   resv0;
    uint16_t  resv1;
}mqttTaskPara;
...
int mqtt_recv_task_Init(mqtt_context *mqttContext);
