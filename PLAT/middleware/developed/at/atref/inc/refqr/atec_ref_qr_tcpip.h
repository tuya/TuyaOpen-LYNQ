...
*
******************************************************************************/
#ifndef _ATEC_REF_QR_TCP_IP_H_
#define _ATEC_REF_QR_TCP_IP_H_
...
#define AT_QICFG_15_TCP_KEEPALIVE_WITH_RAT_MIN            (0)
#define AT_QICFG_15_TCP_KEEPALIVE_WITH_RAT_MAX            (1)
#define AT_QICFG_15_TCP_KEEPALIVE_WITH_RAT_DEF            (0)




#ifdef  FEATURE_PS_REF_QR_TCPIP_QSOCK_AT_ENABLE
/**********************function api define****************************************/
...
#ifdef FEATURE_PS_REF_QR_TCPIP_QPING_SERVICE_ENABLE
CmsRetId  nmQIPING(const AtCmdInputContext *pAtCmdReq);
#endif

#ifdef FEATURE_PS_REF_QR_TCPIP_QSNTP_SERVICE_ENABLE
CmsRetId  nmQINTP(const AtCmdInputContext *pAtCmdReq);
#endif

#ifdef FEATURE_PS_REF_QR_TCPIP_QNETCONFIG_AT_ENABLE
...
#if defined(FEATURE_PS_REF_QR_COMMON_AT_ENABLE) && defined(FEATURE_PS_REF_QR_TCPIP_QSOCK_AT_ENABLE)
