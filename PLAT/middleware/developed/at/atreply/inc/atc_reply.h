...
/*
 * ATC reply/URC common/basic char element
*/
#define ATC_S3_S4_STR           "\r\n"
#define ATC_OK_STR              "OK"
#define ATC_ERROR_STR           "ERROR"
#define ATC_CME_ERR_STR         "+CME ERROR: "
#define ATC_CMS_ERR_STR         "+CMS ERROR: "
//#define ATC_SOCKET_ERR_STR      "+SOCKET ERROR: "
...
typedef enum AtResultCode_Tag
{
    ...
    */
    ...
    AT_RC_MDMP_ERROR,            //Ref cr dm
    AT_RC_MFTP_ERROR,
    AT_RC_TGAI_ERROR,
}AtResultCode;

#ifdef FEATURE_PS_REF_CR_EPS_AT_ENABLE
typedef enum RefCrMtErrorResultCode_TAG
{
    CME_REF_CR_START_ERROR              = 6000,
    CME_REF_CR_CHANNEL_BLOCKING         = CME_REF_CR_START_ERROR,
    CME_REF_CR_LEN_OF_COMMAND_EXCEED    = 6001,
    CME_REF_CR_SMS_INPUT_ERROR          = 6002,
    CME_REF_CR_COMMAND_NOT_RECOGNIZ     = 6003,
    CME_REF_CR_PARA_OF_COMMAND_ERROR    = 6004,

    CME_REF_CR_END_ERROR = 8000
}RefCrMtErrorResultCode;
#endif
...
* RING URC
*/
CmsRetId atcRingURC(UINT32 chanId, const CHAR *pUrcStr);
