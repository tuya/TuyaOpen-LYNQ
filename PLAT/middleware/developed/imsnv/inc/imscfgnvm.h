...
*/
    ...
    /* e.g.: "SsMoDeactBr"                        value type: bool */
    #define ICFG_JSON_SS_MO_DEACT_BR_KEY_BOOL     "SsMoDeactBr"
    ...
    /* e.g.: "SsXcapFqdn":""                   value type: string */
    #define ICFG_JSON_SS_XCAP_ROOT_URI_KEY_STR    "SsXcapFqdn"
    /* e.g.: "SsBsfFqdn":""                    value type: string */
    #define ICFG_JSON_SS_BSF_ROOT_URI_KEY_STR     "SsBsfFqdn"
    /* e.g.: "SsXcapSrvPort":80                   value type: number */
    #define ICFG_JSON_SS_XCAP_LCL_PORT_KEY_UINT16 "SsXcapSrvPort"
    /* e.g.: "SsBsfSrvPort":8080                  value type: number */
    #define ICFG_JSON_SS_BSF_LCL_PORT_KEY_UINT16  "SsBsfSrvPort"
    ...
    /* e.g.: "xcapApn":""                       value type: string */
    #define ICFG_JSON_SS_XCAP_APN_STR           "XcapApn"

    /* e.g.: "xcapRoot":""                       value type: string */
    #define ICFG_JSON_SS_XCAP_ROOT_STR           "XcapRoot"

    /* e.g.: "xcapAuid":""                       value type: string */
    #define ICFG_JSON_SS_XCAP_AUID_STR           "XcapAuid"

    /* e.g.: "SsTelUri":""                       value type: bool */
    #define ICFG_JSON_SS_TEL_URI_KEY_BOOL        "SsBeTelUri"

    /* e.g.: "SsProductVer":""                   value type: string */
    #define ICFG_JSON_SS_PRODUCTVER_STR          "SsProductVer"
...
typedef struct _EPAT_ImsSupSrvCfg_Tag
{
    ...
    UINT32      utAuthType: 3;             /*0:GBA-ME; 1,GBA-DIGEST;2,GBA-UICC;3,HTTP-DIGEST,4,authentication is NULL*/
    UINT32      ipPerferType :1;           /*0:V4 Prefer; 1: V6 perfer*/
    UINT32      moDeactXcapBr:1;           /*mo trigger to deact the xcap br when ut service is finished*/
    UINT32      bTelUri :1;                /*sip uri format or tel format*/
    UINT32      resv: 21;
    ...
    CHAR        xcapApn[IMS_APN_MAX_STR_LEN];

    CHAR        xcapRoot[IMS_XCAP_ROOT_MAX_LEN];
    CHAR        xcapAuid[IMS_XCAP_AUID_MAX_LEN];

    CHAR        clientName[IMS_XCAP_CLIENTNAME_MAX_LEN];
