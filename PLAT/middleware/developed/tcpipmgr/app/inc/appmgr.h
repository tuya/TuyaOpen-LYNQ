 ...
 * Comment:
******************************************************************************/
AppMgrResult AppMgrPingRequest(ip_addr_t *pDest, INT32 count, UINT16 payloadLen, UINT32 timeout, BOOL raiFlag, UINT16 reqHandle, UINT8 cid);
 ...
 * Comment:
******************************************************************************/
AppMgrResult AppMgrPingUrlRequest(const CHAR* pingTarget, INT32 count, UINT16 payloadLen, UINT32 timeout, BOOL raiFlag, UINT16 reqHandle, UINT8 cid);
 ...
 * Comment:
******************************************************************************/
AppMgrResult AppMgrSntpStart(CHAR *server, UINT16 port, UINT16 reqHandler, BOOL autoSync, UINT8 cid, UINT8 retryTimes, UINT16 timeout);
