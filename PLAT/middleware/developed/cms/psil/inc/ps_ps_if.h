...
CmsRetId psSetCevdp(UINT32 atHandle, UINT8 cevdp);
CmsRetId psGetCevdp(UINT32 atHandle);
...
CmiRcCode psGetEMCATTSync(UINT8 *pPsState);

CmsRetId psSetEmcAttachState (UINT32 atHandle, BOOL bAttached);
