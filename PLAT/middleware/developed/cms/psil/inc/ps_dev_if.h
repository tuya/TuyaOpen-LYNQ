...
CmsRetId devGetECBCINFO(UINT32 atHandle, CmiDevGetBasicCellListInfoReq *pGetBcInfoReq, CHAR *pFreqList, CHAR *pBandList);
...
CmsRetId devStopWIFISCAN(UINT32 atHandle);
...
CmsRetId devSetEcLogDumpReq(UINT32 atHandle, CmiDevSetLogDumpReq *pSetLogDumpReq);
#endif
