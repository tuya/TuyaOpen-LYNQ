 ...
 * CPNER <reporting>
*/
typedef enum PsilSmsCpnerRpt_enum
{
    PSIL_SMS_CPNER_REPORT_DISABLE = 0,
    PSIL_SMS_CPNER_REPORT_ENABLE = 1,
    PSIL_SMS_CPNER_REPORT_END
}PsilSmsCpnerRpt;
...
CmsRetId smsSetStoredInSimSmsMsg(UINT32 atHandle, UINT8 savedMode, UINT8 smsStatus, BOOL scAddrPresent,
                                 CmiSmsAddressInfo * pScAddr, CmiSmsPdu * pSavedSmsPdu, UINT16 smsUniqId);
...
void smsSendNewMsgRsp(UINT32 reqHandle, UINT8 smsId, UINT32 reply, UINT8 tpCause, UINT16 ackPduLen, UINT8 *ackPdu, BOOL bSmsOverIp);
