...
*/
void psDialNetDevCtl(UINT8 op, UINT8 cid, UINT8 bUrcEn);

void psDialNetDevCtlWithoutSave(UINT8 op, UINT8 cid, UINT8 bUrcEn);
...
#if FEATURE_PS_REF_CR_EPS_AT_ENABLE
void psDialMipcallAutoConn(UINT8 cid);
#endif
