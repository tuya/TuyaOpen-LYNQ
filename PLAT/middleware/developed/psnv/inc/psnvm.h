...
typedef struct _EPAT_CesmPdpDefinition_tag
{
    ...
    UINT8   pcscfDisType;       /* 0 - Preference of P-CSCF address discovery not influenced
                                 ...
                                 */
    UINT8   imCnSigFlagReq;     /* 0 - UE indicates that the PDP context is not for IM CN subsystem-related signalling only
 ...
 * CEMM EHPLMNLIST NVM
******************************************************************************/
#define CUR_CEMM_EHPLMN_LIST_NVM_VER    0x01
