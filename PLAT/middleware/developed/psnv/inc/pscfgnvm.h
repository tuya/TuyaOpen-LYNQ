...
typedef enum _EPAT_PsConfigParamId_Enum
{
    ...
    CEPLMN_CFG_OOS_PLMN_INTERVAL,                   /* TLV, PsCfgPlmnOosInterval */
    CEPLMN_CFG_ATTEMPT_HPLMN,                       /* TV,  BOOL */
    ...
    CEMM_CFG_VOICE_DOMAIN_PREFER = 40,              /* TLV, VoiceDomainPreferenceT */
    ...
    CEMM_CFG_UE_USAGE_SETTING,                      /* TV,  UeUsageSettingT */
    CEMM_CFG_FAKE_CELL_OPT,                         /* TLV, PsCfgCemmFakeCellOpt */
    CEPLMN_CFG_PLMN_SEARCH_OPT,                     /* TV,  PlmnSearchOpt */
    ...
    L2_CFG_DATA_COUNTER_INFO = 61,                  /* TLV, PsCfgL2DataCounterInfo */
    CCM_CFG_SMS_CSCB_SETTING = 62,                  /* TLV, CcmCscbNvmConfig, AT+CSCB */
    CCM_CFG_EMERGENCY_CAMP = 63,                    /* TV,  BOOL bEnableEmergencyCamp */

    UICC_CFG_SIM_SLOT = 64,                         /* TV,  UINT8 simSlot */

    CESM_CFG_PDP_REMAP = 65,                        /* TV,  UINT8 bPdpRemap
                                                     * 0 - disabled,
                                                     * 1 - remap once for attached bearer,
                                                     * 2 - always remap if APN/IP type is same
                                                    */
    CESM_CFG_PDP_REACT = 66,                        /* TV,  UINT8 bPdpReact, 0/1,
                                                     * 1 - default bearer/PDP is need to re-act if APN/IP type changes, when CGACT
                                                    */
    CERRC_CFG_STATIC_CONFIG = 67,                   /* TV,  BOOL staticConfig */
    CERRC_CFG_DISABLE_CDRX_CONFIG = 68,             /* TV,  UINT8 disableCDRX */
    CERRC_CFG_USER_DRX_CYCLE = 69,                  /* TV,  UINT8 userDrxCycle */

    PS_CFG_IMS_SOLUTION_TYPE = 70,                  /* TV,  UINT8 psImsSolutionType PsImsSolutionType
                                                     * 0 - no IMS solution
                                                     * 1 - HIMS
                                                     * 2 - EIMS
                                                    */
    CERRC_CFG_ROHC_PROFILE_BIT = 71,                /* TV,  UINT16 rohcProfileBit */
    CERRC_CFG_ENABLE_SPS = 72,                      /* TV,  BOOL enableSps */
    CERRC_CFG_ENABLE_TTIBUNDLING = 73,              /* TV,  BOOL ttiBundling */
    CERRC_CFG_MEAS_ADJUST_SETTING = 74,             /* TLV, CerrcCcmMeasAdjustConfig, AT+ECMEASCFG */
    CERRC_CFG_CFUN_CLEAR_BARCELL = 75,              /* TV,  BOOL cfunClrBarCell */
    CERRC_CFG_ENABLE_LOGGED_MDT = 76,               /* TV,  BOOL enableLoggedMDT */
    CERRC_CFG_TX_POWER_THRESHOLD_RPT = 77,          /* TLV, CerrcTxPowerThresholdRptCfg */

    CCM_CFG_SMALL_UL_TBS_OPT = 78,                  /* TV,  BOOL smallUlTbsOpt */
    CERRC_CFG_L2_EXT_SN_CAPA_BITMAP = 79,           /* TV,  UINT8,L2 extended SN capability definition,via bitmap. */

    CEMM_CFG_T3402_OPT = 80,                        /* TV,  BOOL T3402Opt */
    CEMM_CFG_ANTIDETECT = 81,                       /* TV,  BOOL */

    UICC_CFG_ISIM_DISABLE = 82,                     /* TV,  BOOL bIsimDisable, whether disable ISIM app or not */
    CEMM_CFG_CLEAR_FORBIDDEN_TAC = 83,              /* TV,  BOOL clear list of forbidden TAC when perform AT+CGATT=0 */
    CEMM_CFG_FORBIDDEN_TAC_TIMER = 84,              /* TV,  UINT16 timer values of periodically remove list of forbidden TAC */
    CERRC_CFG_AS_UE_CAPA_BITMAP = 85,               /* TLV,  UINT32,AS UE capability definition,via bitmap. */
    CESM_CFG_SAME_IP_ADDR_PROC = 86,                /* TV,  UINT8 sameIpAddrProc, 0/1,
                                                     * 0 - deactivate new PDN
                                                     * 1 - deactivate old PDN
                                                     * other value reserved
                                                    */
    UICC_CFG_USER_SET_TEST_SIM_ENABLE = 87,         /* TV,  BOOL bUserSetTestSim, whether user set test SIM */
    CEMM_CFG_USER_SET_OPERATOR_ID = 88,             /* TV,  UINT8 user set operator ID */

    CESM_CFG_EIT_PCO_CONEXIST = 89,                 /* TV,  BOOL bEitPcoConexist, 0/1,
                                                     * 0 - disabled
                                                     * 1 - enabled
                                                    */
    CERRC_CFG_BAR_AFTER_RRC_TRY_NUM = 90,           /* TV,  UINT8 barAfterRrcTryNum */
    UICC_CFG_SIM_GEN_ACC_REQ_GET_RSP_ENABLE = 91,   /* TV,  BOOL bSimGenAccReqGetRsp, whether SIM generic access required Get Response cmd */
    UICC_CFG_SIM_GEN_ACC_LARGE_APDU_RSP_SIZE = 92,  /* TV,  UINT16 simGenAccLargeApduRspSize, SIM generic access large APDU response size */
    CERRC_CFG_ENABLE_RECV_SIB_OPT = 93,             /* TV,  BOOL bEnableSibRevOpt */
    CERRC_CFG_RELAX_MONITOR_EVAL_TIME = 94,         /* TV,  UINT16 tSearchDeltaP */
    CEMM_CFG_CELL_PREFER_FDD_OR_TDD = 95,           /* TLV, PsCfgCemmCellPreferTddOrFdd */
    UICC_CFG_SIM_PRESENCE_DETECT_PERIOD = 96,       /* TV,  UINT8 simPreDetectPeriod, SIM presence detection period */
    CEPLMN_CFG_QUICK_SEARCH = 97,                   /* TV,  BOOL */
    /*
     * !!!!  PARAM ID !!!!
     * 1> Only allowed
     *   a) add into the end
...
/*
 * CEPLMN_CFG_OOS_PLMN_INTERVAL
*/
#pragma pack(1)
typedef struct _SIG_EPAT_CEPLMN_CFG_OOS_PLMN_INTERVAL
{
    /* parameters of PLMN search power level: 0, 1, 2, 3, 4 (AT+ECPLMNINTERVAL) */
    UINT16          plmnMaxGuardTimeS[5];   /* guard timer of PLMN search, should > 0, and if set to 0xFFFF, means no guard timer */
    UINT16          interval0[5];           /* OOS timer value in unit of second after 1st round of PLMN search,
                                             *  must > 0, and if set to "0xFFFF", means that if still OOS in this round, no PLMN search later
                                            */
    UINT16          interval1[5];           /* OOS timer value in unit of second after 2nd round of PLMN search*/
    UINT16          interval2[5];           /* OOS timer value in unit of second after 3rd round of PLMN search*/
}PsCfgPlmnOosInterval;   // 40 bytes
#pragma pack()
...
/*
 * CEMM_CFG_CELL_PREFER_FDD_OR_TDD
*/
typedef struct _SIG_EPAT_CEMM_CFG_CELL_PREFER_FDD_OR_TDD
{
    UINT8   cellPreferMode;
    UINT8   cellPreferScoreAdd;
    UINT8   rsvd[2];
}PsCfgCemmCellPreferTddOrFdd;
...
/**
  \fn           BOOL OsaCfgNvmParseParam(const OsaCfgParam *pCfgParam, UINT8 cfgType, UINT16 expectLen, void *pOutValue)
  \brief        parse the config parameter from OsaCfgParam
  \param[in]    pCfgParam       OsaCfgParam
  \param[in]    cfgType         TV or TLV type
  \param[in]    expectLen       expect parameter length
  \param[out]   pOutValue       parameter output
  \returns      BOOL   //OsaNvmRet
*/
#define PsCfgNvmParseParam                  OsaCfgNvmParseParam
...
/* to Set the default OOS PLMN interval */
void PsCfgDefaultOosPlmnInterval(PsCfgPlmnOosInterval *pOosPlmnInterval);

/* to Set the default Fake Cell Opt value */
void PsCfgDefaultCemmFakeCellOptSetting(PsCfgCemmFakeCellOpt *pCemmFakeCellOpt);

/* to Set the default cell prefer value */
void PsCfgDefaultCellPreferSetting(PsCfgCemmCellPreferTddOrFdd *pCemmCellPrefer);
