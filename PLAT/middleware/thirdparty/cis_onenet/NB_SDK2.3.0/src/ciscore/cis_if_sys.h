...
#endif
#define cissys_assert( x )  EC_ASSERT(x,0,0,0)
...
#else
#define CIS_MAX_DL_BUFFER_NUM	40
#endif
...
//bool        cissys_updateFirmware(cissys_callback_t *cb);EC comment
