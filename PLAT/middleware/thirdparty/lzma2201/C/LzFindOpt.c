...
#ifdef LOG_ITERS
#include <stdio.h>
LZMA_BSS_SECTION UInt64 g_NumIters_Tree;
LZMA_BSS_SECTION UInt64 g_NumIters_Loop;
LZMA_BSS_SECTION UInt64 g_NumIters_Bytes;
#define LOG_ITER(x) x
#else
#define LOG_ITER(x)
#endif
...
PLAT_BL_UNCOMP_FLASH_TEXT UInt32 * MY_FAST_CALL GetMatchesSpecN_2(const Byte *lenLimit, size_t pos, const Byte *cur, CLzRef *son,
