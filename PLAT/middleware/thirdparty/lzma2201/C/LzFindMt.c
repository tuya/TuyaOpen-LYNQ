...
PLAT_BL_UNCOMP_FLASH_TEXT static WRes MtSync_Create_WRes(CMtSync *p, THREAD_FUNC_TYPE startAddress, void *obj)
{
  WRes wres;
...
PLAT_BL_UNCOMP_FLASH_TEXT static void HashThreadFunc(CMatchFinderMt *mt)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT static void BtGetMatches(CMatchFinderMt *p, UInt32 *d)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT static void BtFillBlock(CMatchFinderMt *p, UInt32 globalBlockIndex)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT void MatchFinderMt_Construct(CMatchFinderMt *p)
{
  p->hashBuf = NULL;
...
PLAT_BL_UNCOMP_FLASH_TEXT static void MatchFinderMt_FreeMem(CMatchFinderMt *p, ISzAllocPtr alloc)
{
  ISzAlloc_Free(alloc, p->hashBuf);
  p->hashBuf = NULL;
}

PLAT_BL_UNCOMP_FLASH_TEXT void MatchFinderMt_Destruct(CMatchFinderMt *p, ISzAllocPtr alloc)
{
  /*
...
PLAT_BL_UNCOMP_FLASH_TEXT static THREAD_FUNC_DECL BtThreadFunc2(void *p)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT SRes MatchFinderMt_Create(CMatchFinderMt *p, UInt32 historySize, UInt32 keepAddBufferBefore,
...
PLAT_BL_UNCOMP_FLASH_TEXT SRes MatchFinderMt_InitMt(CMatchFinderMt *p)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT static void MatchFinderMt_Init(CMatchFinderMt *p)
{
  CMatchFinder *mf = MF(p);
...
PLAT_BL_UNCOMP_FLASH_TEXT void MatchFinderMt_ReleaseStream(CMatchFinderMt *p)
{
  // Sleep(1); // for debug
...
PLAT_BL_UNCOMP_FLASH_TEXT static const Byte * MatchFinderMt_GetPointerToCurrentPos(CMatchFinderMt *p)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT static UInt32 MatchFinderMt_GetNumAvailableBytes(CMatchFinderMt *p)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT static UInt32 * MixMatches2(CMatchFinderMt *p, UInt32 matchMinPos, UInt32 *d)
{
  UInt32 h2, c2;
  UInt32 *hash = p->hash;
...
PLAT_BL_UNCOMP_FLASH_TEXT static UInt32 * MixMatches3(CMatchFinderMt *p, UInt32 matchMinPos, UInt32 *d)
{
  UInt32 h2, h3, c2, c3;
  UInt32 *hash = p->hash;
  const Byte *cur = p->pointerToCurPos;
...
PLAT_BL_UNCOMP_FLASH_TEXT static UInt32 *MixMatches4(CMatchFinderMt *p, UInt32 matchMinPos, UInt32 *d)
{
...
PLAT_BL_UNCOMP_FLASH_TEXT static UInt32* MatchFinderMt2_GetMatches(CMatchFinderMt *p, UInt32 *d)
{
  const UInt32 *bt = p->btBufPos;
  const UInt32 len = *bt++;
  const UInt32 *btLim = bt + len;
...
PLAT_BL_UNCOMP_FLASH_TEXT static UInt32* MatchFinderMt_GetMatches(CMatchFinderMt *p, UInt32 *d)
{
  const UInt32 *bt = p->btBufPos;
  UInt32 len = *bt++;
...
PLAT_BL_UNCOMP_FLASH_TEXT static void MatchFinderMt0_Skip(CMatchFinderMt *p, UInt32 num)
{
  SKIP_HEADER2_MT { p->btNumAvailBytes--;
  SKIP_FOOTER_MT
}

PLAT_BL_UNCOMP_FLASH_TEXT static void MatchFinderMt2_Skip(CMatchFinderMt *p, UInt32 num)
{
  SKIP_HEADER_MT(2)
      UInt32 h2;
      MT_HASH2_CALC
...
PLAT_BL_UNCOMP_FLASH_TEXT static void MatchFinderMt3_Skip(CMatchFinderMt *p, UInt32 num)
{
  SKIP_HEADER_MT(3)
      UInt32 h2, h3;
      MT_HASH3_CALC
...
PLAT_BL_UNCOMP_FLASH_TEXT void MatchFinderMt_CreateVTable(CMatchFinderMt *p, IMatchFinder2 *vTable)
{
