...
PLAT_BL_CIRAM_FLASH_TEXT static void *SzAlloc(ISzAllocPtr p, size_t size) { UNUSED_VAR(p); return MyAlloc(size); }
PLAT_BL_CIRAM_FLASH_TEXT static void SzFree(ISzAllocPtr p, void *address) { UNUSED_VAR(p); MyFree(address); }
