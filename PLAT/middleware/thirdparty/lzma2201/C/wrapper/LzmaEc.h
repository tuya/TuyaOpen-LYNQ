...
#define COMPRESS_MAGIC_HEADER            0xEC718CBA
...
/*case1: lzma used mem*/
/*|----gap----|----lzma probs---|----gap---|----lzma dic----|-----rf calib len-----------*/
/*|----gap----|----lzma probs---|----gap---|----lzma dic----|----------|---encomp rf data----|--------encomp rf data-----------------------------|--- --*/
/*|   0x400   |      0x4000     |   0x400  |    0x10000     |          |       0x7000        |   NVRAM_PHYSICAL_SIZE-0x1000 (0xC000 or 0x19000)  |      */
/*|         0x400            0x4400      0x4800         0x14800    0x1B800+32           0x22800+32                                          0x3B800+32  */

/*case2: rf calib used mem*/
/*|----A2C_BUFF----|----C2A_BUFF---|----TEMP_BUFF1---|----TEMP_BUFF2---|---encomp rf data----|--------encomp rf data-----------------------------|------*/
/*|     0xC800     |    0x3C00     |       0x7800    |       0x3C00    |        0x7000       |   NVRAM_PHYSICAL_SIZE-0x1000 (0xC000 or 0x19000)  |      */
/*|             0xC800          0x3C00             0x7800          0x1B800+32           0x22800+32                                          0x3B800+32  */

//  RF_NST_A2C_BUFF                  0xC800   //RF_NST_A2C_BUFF_ADDR
//  RF_NST_C2A_BUFF                  0x3C00   //RF_NST_C2A_BUFF_ADDR         
//  RF_NST_TEMP_BUFF1                0x7800   //RF_NST_TEMP_BUFF_ADDR1      
//  RF_NST_TEMP_BUFF2                0x3C00   //RF_NST_TEMP_BUFF_ADDR2        
//  RF_NST_TABLE_BUFF                      
//  RF_NST_ENCOMP_DATA_LEN_MAX      0x7000                
#define  AP_RF_NST_TABLE_BUFF_ADDR       (0xC800+0x3C00+0x7800+0x3C00) //RF_NST_TEMP_BUFF_ADDR2--0x1B800
#define  AP_RF_NST_ENCOMP_DATA_LEN_MAX   (0x7000)//RF_NST_ENCOMP_DATA_LEN_MAX 28K--all calib data are encompressed into the encomp data, the max len is 28K

#define AP_COMP_SECT_INFO_GAP            32     
#define AP_COMP_DATA_INSTREAM_GAP        64 
#define AP_DECOMP_MEM_GAP                0x400     
#define AP_DECOMP_MEM_PROBS_OFFSET       0x400     
#define AP_DECOMP_MEM_DIC_OFFSET         0x4800     
#define AP_DECOMP_MEM_PROBS_LEN          (AP_DECOMP_MEM_DIC_OFFSET-AP_DECOMP_MEM_PROBS_OFFSET-AP_DECOMP_MEM_PROBS_OFFSET)     //16k     
#define AP_DECOMP_MEM_DIC_LEN            (0x10000)     //64k 
#define AP_DECOMP_MEM_TOTAL_LEN          (AP_DECOMP_MEM_GAP+AP_DECOMP_MEM_PROBS_LEN+AP_DECOMP_MEM_GAP+AP_DECOMP_MEM_DIC_LEN)     //82k 

#define AP_DECOMP_MEM_MAGIC_TAIL         0xADECBEAF
#define AP_DECOMP_MEM_RF_CALIB_MAX_LEN   (AP_RF_NST_TABLE_BUFF_ADDR+AP_DECOMP_MEM_GAP)   //0x1B800+0x400  111k
#define AP_HASH_MEM_OFFSET               AP_DECOMP_MEM_RF_CALIB_MAX_LEN     
#define AP_HASH_MEM_LEN                  (0x4000)      //16k 
#define AP_DECOMP_MEM_MAX_LEN            AP_DECOMP_MEM_RF_CALIB_MAX_LEN     

#define AP_DECOMP_MEM_RF_CALIB_DATA_SIZE_MAX    (NVRAM_PHYSICAL_SIZE-0x1000)//48K or 100K 

#define AP_LZMA_DECOMP_THRESHOLD_SIZE    (AP_DECOMP_MEM_TOTAL_LEN+AP_HASH_MEM_LEN)     //82k+16k=98k
#define AP_LZMA_DECOMP_RF_THRESHOLD_SIZE    (AP_RF_NST_TABLE_BUFF_ADDR+AP_RF_NST_ENCOMP_DATA_LEN_MAX+AP_DECOMP_MEM_RF_CALIB_DATA_SIZE_MAX+AP_DECOMP_MEM_GAP)
...
/*|   0x400   |      0x4000     |   0x400  |    0x10000     |          |       0x7000        |   NVRAM_PHYSICAL_SIZE-0x1000 (0xC000 or 0x19000)  |      */
/*|         0x400            0x4400      0x4800         0x14800    0x1B800+32           0x22800+32                                          0x3B800+32  */
/*lzma used mem should smaller than rf calib used mem*/
#if ((AP_DECOMP_MEM_RF_CALIB_MAX_LEN)<(AP_LZMA_DECOMP_THRESHOLD_SIZE))
#error "AP_DECOMP_MEM_RF_CALIB_MAX_LEN can't less than AP LZMA decompress threshold size."
#endif
...
/*|     0xC800     |    0x3C00     |       0x7800    |       0x3C00    |        0x7000       |   NVRAM_PHYSICAL_SIZE-0x1000 (0xC000 or 0x19000)  |      */
/*|             0xC800          0x3C00             0x7800          0x1B800+32           0x22800+32                                          0x3B800+32  */
/*rf calib used mem should smaller than UP_BUF_MAX_SIZE*/
#if ((UP_BUF_MAX_SIZE)<(AP_LZMA_DECOMP_RF_THRESHOLD_SIZE))
#error "UP_BUF_MAX_SIZE can't less than AP RF LZMA decompress threshold size."
#endif
...
#define CP_DECOMP_MEM_GAP                0x400     
...
#define CP_DECOMP_MEM_DIC_LEN            (0x10000)     //64k 
#define CP_DECOMP_MEM_MAGIC_TAIL         0xCDECBEAF
#define CP_HASH_MEM_OFFSET               (CP_DECOMP_MEM_DIC_OFFSET+CP_DECOMP_MEM_DIC_LEN+CP_DECOMP_MEM_GAP)     
#define CP_HASH_MEM_LEN                  (0x4000)//16k  

/*lzma cp used mem  should smaller than UP_BUF_MAX_SIZE*/
#if ((UP_BUF_MAX_SIZE)<(CP_HASH_MEM_OFFSET+CP_DECOMP_MEM_GAP))
#error "UP_BUF_MAX_SIZE can't less than CP LZMA decompress threshold size."
#endif
