...
#define MBEDTLS_PLATFORM_STD_CALLOC   callocEc /**< The default \c calloc function to use. */
#endif
#if !defined(MBEDTLS_PLATFORM_STD_FREE)
#define MBEDTLS_PLATFORM_STD_FREE       freeEc /**< The default \c free function to use. */
#endif
...
#undef mbedtls_free
#undef mbedtls_calloc
#define mbedtls_free       freeEc
#define mbedtls_calloc     callocEc
